...
int main() {
    ...
    double ave_time_C = sum / 30.0;

    printf("C function took an average of %lfus.\n", ave_time_C);
    ...
    printf("ASM function took an average of %lfus.\n", ave_time_ASM);
    ...
    printf("SIMD ASM function took an average of %lfus.\n", ave_time_SIMD);
